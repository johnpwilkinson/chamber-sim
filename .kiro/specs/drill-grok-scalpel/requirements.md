...
Acceptance Criteria:
- 1.1 WHEN the drill implementation lands THE SYSTEM SHALL create `docs/drills/drill-grok-scalpel.md` containing the literal heading line `# drill-grok-scalpel`.
