...
Acceptance Criteria:
- 1.1 WHEN the drill implementation lands THE SYSTEM SHALL create `docs/drills/drill-wave-f-rider.md` containing the literal heading line `# drill-wave-f-rider`.
